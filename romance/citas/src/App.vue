...
const objetosData = [
  { nombre: "Batidora Fiestera", img: "/src/assets/batidora.png", humor: "Si no hay música, yo la pongo." },
  { nombre: "Bota Perdida", img: "/src/assets/bota.png", humor: "Estoy buscando a mi media… ¿me ayudas?" },
  { nombre: "Calcetín Perdido", img: "/src/assets/calcetin.png", humor: "Desde la lavadora no volví a ser el mismo…" },
  { nombre: "Control Remoto Perfeccionista", img: "/src/assets/control.png", humor: "Tengo botones… pero contigo pierdo el control." },
  { nombre: "Cuchara Existencial", img: "/src/assets/cuchara.png", humor: "¿Seré una cuchara… o un reflejo de algo más profundo?" },
  { nombre: "Espejo Vanidoso", img: "/src/assets/espejo.png", humor: "Mírame… digo… mírate." },
  { nombre: "Cuchillo Angustiado", img: "/src/assets/cuchillo.png", humor: "No quiero cortar… pero la vida me obliga…" },
  { nombre: "Lámpara Romántica", img: "/src/assets/lampara.png", humor: "Siempre ilumino tus momentos… incluso los que deberías apagar." },
  { nombre: "Plato Solitario", img: "/src/assets/plato.png", humor: "Siempre vacío… excepto cuando te veo." },
  { nombre: "Radio Nostálgico", img: "/src/assets/radio.png", humor: "Todo tiempo pasado sonaba mejor…" },
  { nombre: "Reloj Paranoico", img: "/src/assets/reloj.png", humor: "Tic… ¿escuchaste eso?… Tac…" },
  { nombre: "Rollo Justiciero", img: "/src/assets/rollo.png", humor: "Yo limpio el mundo… ¡uno por uno!" },
  { nombre: "Taza Sarcástica", img: "/src/assets/taza.png", humor: "Ah sí… café otra vez… wow." },
  { nombre: "Tostador Romántico", img: "/src/assets/tostador.png", humor: "Caliento pan… pero contigo caliento el corazón." }
];
